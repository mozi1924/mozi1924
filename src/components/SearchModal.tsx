...
export default function SearchModal({ variant = 'inline' }: Props) {
            ...
            try {
                ...
                if (typeof window.pagefind === "undefined") {
                    try {
                        ...
                        console.warn("Pagefind not found (development mode?)", e);
                    }
                } else {
                    // @ts-ignore
    ...
    const performSearch = useCallback(async (q: string) => {
        ...
        try {
            ...
            // Load the top 5 results data immediately
    ...
    useEffect(() => {
        ...
        if (isOpen) {
            ...
            // Don't clear query immediately to avoid flicker if re-opened quickly
        }
        ...
        const handleKeyDown = (e: KeyboardEvent) => {
            ...
            if (e.key === 'ArrowDown') {
                ...
                if (results[selectedIndex]) {
                    ...
                    // Handle selecting recent (if logic allows)
                }
            }
        };
                    ...
                    <div className={`relative w-full max-w-2xl bg-[#1a1a1a] border border-white/10 rounded-xl shadow-2xl overflow-hidden flex flex-col max-h-[70vh] transition-all duration-300 delay-75 ${isOpen && isVisible ? 'opacity-100 scale-100 translate-y-0' : 'opacity-0 scale-95 -translate-y-4'
                        ...
                        <div className="flex items-center border-b border-white/10 px-4 py-4 shrink-0">
                            ...
                            <input
                                ...
                                placeholder={pagefind ? "Search articles, blogs..." : "Search unavailable (build required)"}
                                disabled={!pagefind}
